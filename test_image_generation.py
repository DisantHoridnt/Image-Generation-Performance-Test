...
# Endpoint URLs
init_url = "https://api.runpod.ai/v2/3y76wcsit0wq2a/run"
status_url = "https://api.runpod.ai/v2/3y76wcsit0wq2a/status/"
...
headers = {
    ...
    "Authorization": "Bearer IB1FH2AGCOJXB3FK5T7V5KM8NZRU0QDDT7E8CK3Y"
}
